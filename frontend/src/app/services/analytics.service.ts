...
import { DashboardSummary, JobAnalytics, UserAdmin, AdminStats } from '../models/job-tracker.models';

@Injectable({
  providedIn: 'root'
})
export class AnalyticsService {
  private apiUrl = 'http://localhost:5050/api/analytics';
  ...
  public getDetailedAnalytics(): Observable<JobAnalytics> {
    return this.http.get<JobAnalytics>(`${this.apiUrl}/detailed`);
  }
}
